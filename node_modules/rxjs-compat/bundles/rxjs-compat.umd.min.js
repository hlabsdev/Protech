...
c)};a.prototype.nextTimeWindow=function(c){this._events.push(new Df(this._getNow(),c));this._trimBufferThenGetEvents();b.prototype.next.call(this,c)};a.prototype._subscribe=function(c){var a=this._infiniteTimeWindow,b=a?this._events:this._trimBufferThenGetEvents(),f=this.scheduler,k=b.length,g;if(this.closed)throw new M;this.isStopped||this.hasError?g=p.EMPTY:(this.observers.push(c),g=new fd(this,c));f&&c.add(c=new md(c,f));if(a)for(a=0;a<k&&!c.closed;a++)c.next(b[a]);else for(a=0;a<k&&!c.closed;a++)c.next(b[a].value);
this.hasError?c.error(this.thrownError):this.isStopped&&c.complete();return g};a.prototype._getNow=function(){return(this.scheduler||kd).now()};a.prototype._trimBufferThenGetEvents=function(){for(var c=this._getNow(),a=this._bufferSize,b=this._windowTime,f=this._events,k=f.length,g=0;g<k&&!(c-f[g].time<b);)g++;k>a&&(g=Math.max(g,k-a));0<g&&f.splice(0,g);return f};return a}(w),Df=function(){return function(b,a){this.time=b;this.value=a}}(),W=function(b){function a(){var c=null!==b&&b.apply(this,arguments)||
...
this.value);b.prototype.complete.call(this)};return a}(w),Ef=1,Ff=Promise.resolve(),Ea={},nd={setImmediate:function(b){var a=Ef++;Ea[a]=!0;Ff.then(function(){return bb(a)&&b()});return a},clearImmediate:function(b){bb(b)}},Gf=function(b){function a(c,a){var d=b.call(this,c,a)||this;d.scheduler=c;d.work=a;return d}h(a,b);a.prototype.requestAsyncId=function(c,a,e){void 0===e&&(e=0);if(null!==e&&0<e)return b.prototype.requestAsyncId.call(this,c,a,e);c.actions.push(this);return c.scheduled||(c.scheduled=
nd.setImmediate(c.flush.bind(c,null)))};a.prototype.recycleAsyncId=function(c,a,e){void 0===e&&(e=0);if(null!==e&&0<e||null===e&&0<this.delay)return b.prototype.recycleAsyncId.call(this,c,a,e);0===c.actions.length&&(nd.clearImmediate(a),c.scheduled=void 0)};return a}(ma),ya=new (function(b){function a(){return null!==b&&b.apply(this,arguments)||this}h(a,b);a.prototype.flush=function(c){this.active=!0;this.scheduled=void 0;var a=this.actions,b,f=-1,k=a.length;c=c||a.shift();do if(b=c.execute(c.state,
...
function(c,a,e){void 0===e&&(e=0);if(null!==e&&0<e||null===e&&0<this.delay)return b.prototype.recycleAsyncId.call(this,c,a,e);0===c.actions.length&&(cancelAnimationFrame(a),c.scheduled=void 0)};return a}(ma),If=new (function(b){function a(){return null!==b&&b.apply(this,arguments)||this}h(a,b);a.prototype.flush=function(c){this.active=!0;this.scheduled=void 0;var a=this.actions,b,f=-1,k=a.length;c=c||a.shift();do if(b=c.execute(c.state,c.delay))break;while(++f<k&&(c=a.shift()));this.active=!1;if(b){for(;++f<
